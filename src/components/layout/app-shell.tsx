  ...
  return (
    <div className="flex min-h-dvh bg-slate-50">
      ...
      <main className="flex min-w-0 flex-1 flex-col">
        <header className="sticky top-0 z-50 flex items-center justify-between gap-3 border-b border-slate-200/70 bg-white/80 px-3 py-3 shadow-[0_1px_0_rgba(15,23,42,0.02)] backdrop-blur-xl sm:px-5 lg:px-7">
          <div className="flex min-w-0 items-center gap-2.5">
            <button
              type="button"
              className="grid h-9 w-9 shrink-0 place-items-center rounded-lg bg-slate-100 text-slate-700 transition hover:bg-slate-200/80 lg:hidden"
