...
function LedgerPage() {
  ...
  function printStatement() {
    ...
    printWindow.document.write(`
      <html>
        <head>
          <title>Party Statement - ${statement.customerName}</title>
          <style>
        ...
        <body>
          <h1>${statement.customerName} - Party Statement</h1>
          <p>As of ${asOfDate}</p>
          <table>
            <thead>
              <tr>
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
              ...
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                ...
                <p className="mb-2 text-xs text-slate-600">
                  Peak billing month: <span className="font-semibold text-slate-900">{analytics.highestBillingMonth}</span> | Peak collection month:{' '}
                  <span className="font-semibold text-slate-900">{analytics.highestCollectionMonth}</span>
                </p>
            ...
            <table className="w-full min-w-[980px]">
              ...
              <tbody>
                {paginatedEvents.map((event, index) => (
                  ...
                  >
                    <td className="px-3 py-3 text-sm text-slate-700">{event.date}</td>
