...
const pageMeta: Record<string, { title: string; subtitle: string }> = {
  ...
  '/new-bill': { title: 'Bills', subtitle: 'Coming next phase' },
  '/new-payment': { title: 'Payments', subtitle: 'Coming next phase' },
  '/ledger': { title: 'Party', subtitle: 'Coming next phase' },
  '/monthly-report': { title: 'Report', subtitle: 'Coming next phase' },
  '/customers': { title: 'Customers', subtitle: 'Coming next phase' },
  '/items': { title: 'Items', subtitle: 'Coming next phase' },
  '/backup': { title: 'Backup', subtitle: 'Coming next phase' },
}

export function AppShell() {
  const pathname = useRouterState({ select: (s) => s.location.pathname })
  const meta = pageMeta[pathname] ?? { title: 'Kapil Billing', subtitle: 'Foundation route' }
